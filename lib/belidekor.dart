...
import 'package:aplikasi_jual_dekor/transaksi.dart';

class BeliDekor extends StatefulWidget {
  final nama;
  final alamat;
  final hp;
//
  BeliDekor({this.nama,this.alamat,this.hp});

  @override
  _BeliDekorState createState() => _BeliDekorState();
}

class _BeliDekorState extends State<BeliDekor> {
                                    ...
                                    children: <Widget>[
                                      FlatButton(
                                        ...
                                        child: Row(
                                          children: <Widget>[
                                            Container(
                                              child: Text('Sewa ', style: TextStyle(
                                                fontSize: 18,
                                                color: Colors.teal,
                                              ),),
                                            ),
